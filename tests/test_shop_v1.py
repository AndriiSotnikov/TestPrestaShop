...
class TestPrestaShop:
    ...
    def test_successful_login(self, driver, login_data, name="John", last_name="Doe"):
    ...
    def test_unsuccessful_login_v1(self, driver, email="incorrect_username@gmail.com", password="incorrect_password"):
        login_page = LoginPage(driver)
        login_page.load()
        login_page.login(email, password)
