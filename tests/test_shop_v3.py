...
class TestPrestaShop:
    ...
    @pytest.mark.parametrize('login_data', [("johndoe7@example.com", "password"), ("johndoe9@example.com","password")])
    def test_successful_login_v3(self, driver, login_data, name="John", last_name="Doe"):
